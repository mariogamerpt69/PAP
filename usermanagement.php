...
<html lang="pt-PT">
    ...
    <body class="sb-nav-fixed">
        ...
        <script>
            ...
            function reporpasswd(id) {
                let postdata = { "type": "reset", "id": id, "ref": window.location.href };
                showResetPostModal('Remover Utilizador', ``, 'Repor Password', 'Cancelar', "/user.php", postdata, cb = function() {});
            }
