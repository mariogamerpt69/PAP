...
const showResetPostModal = (title, description, yesBtnLabel = 'Confirmar', noBtnLabel = 'Voltar', postURL, postVARS, callback) => {
  if (modalWrap !== null) {
    modalWrap.remove();
  }
  ...
  modalWrap.innerHTML = `
    <div class="modal fade" tabindex="-1">
      ...
      <div class="modal-content">
          ...
          <div class="modal-body">
            <input type="text" name="passwd" placeholder="Nova Palavra-passe" id="passwd" required class="form-control">
          </div>
            <div class="modal-footer bg-light">
              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">${noBtnLabel}</button>
              ${value}
